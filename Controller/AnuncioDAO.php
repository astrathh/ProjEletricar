...
class AnuncioDAO
{
    ...
    public function inserir(Anuncio $anuncio)
    {
        ...
        //A função floatval()
        // carro_id preco_anuncio descricao data_publicacao contato_vendedor cor ano km_rodada modificado localizacao aceita_troca final_placa capacidade_bateria usuario_id
        // carro_id preco_anuncio descricao data_publicacao contato_vendedor cor ano km_rodada modificado localizavao aceita_troca final_placa capacidade_bateria usuario_id
        pg_close($conexao);
        if ($resultado) {
